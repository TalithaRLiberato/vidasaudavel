...
export default function Form(){
    ...
    //função que reliza o cálculo do imc recebendo o peso e altura
    function imcCalculator(){
        return setImc((peso/(altura*altura)).toFixed(2))
    }
    //validação do Imc entre o peso e a altura recebida
    ...
    //retorno para onde será mostrado o set dos dados nos espaços
    return(
